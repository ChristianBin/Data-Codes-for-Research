...
def export_sol_result(duc_model, usercutpool, usercutcallback, instance_index, num_of_run): 
    ...
    mip_best_bound = duc_model.solve_details.best_bound
    ...
    uc_data_result = np.vstack([uc_data_result, [start_shut_cost, generation_cost, obj_value, mip_best_bound, cpu_time, \
...
def export_timegap_info(uc_data_result_file):
    ...
    uc_data_result_header = ['total_start_shut_cost','total_gen_cost', 'obj_value', 'mip_best_bound',  'cpu_time(s)', \
